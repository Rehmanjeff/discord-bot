<template>
    <div class="min-h-full">
          ...
          <div class="relative flex items-center justify-center py-5 lg:justify-between">
            ...
            <div class="hidden lg:ml-4 lg:flex lg:items-center lg:pr-0.5">
              <button type="button" class="flex-shrink-0 rounded-full p-1 text-indigo-200 hover:bg-white hover:bg-opacity-10 hover:text-white focus:outline-none focus:ring-2 focus:ring-white">
                ...
                <font-awesome-icon icon="fa-solid fa-bell" class="icon" size="lg" />
              </button>
            ...
            <div class="min-w-0 flex-1 px-12 lg:hidden">
              <div class="mx-auto w-full max-w-xs">
                ...
                <div class="relative text-white focus-within:text-gray-600">
                  ...
                  <input id="desktop-search" class="outline-none block w-full rounded-md border-0 bg-white/20 py-1.5 pl-10 pr-3 text-white placeholder:text-white focus:bg-white focus:text-gray-600 focus:ring-0 focus:placeholder:text-gray-500 sm:text-sm sm:leading-6" placeholder="Search" type="search" name="search" />
                </div>
              </div>
            </div>
                ...
                <div class="divide-y divide-gray-200 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
                  <div class="pb-2 pt-3">
                    ...
                    <div class="mt-3 space-y-1 px-2">
                      ...
                      <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-100 hover:text-gray-800">Link One</a>
                      <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-100 hover:text-gray-800">Link Two</a>
                      <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-100 hover:text-gray-800">Link Three</a>
                      <a href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-100 hover:text-gray-800">Link Four</a>
                    </div>
                  </div>
                  <div class="pb-2 pt-4">
      ...
      <main class="-mt-24 pb-8">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <div class="grid grid-cols-1 items-start gap-4 lg:grid-cols-3 lg:gap-8">
            ...
            <div class="grid grid-cols-1 lg:col-span-1 gap-4">
              <section aria-labelledby="section-2-title">
                <h2 class="sr-only" id="section-2-title">Section title</h2>
                <div class="overflow-hidden rounded-lg bg-white shadow">
                  <div class="p-4 bg-discord-dark min-h-[300px]">
                    <slot name="preview" />
                  </div>
                </div>
              </section>
      ...
      <footer>
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
          <div class="border-t border-gray-200 py-8 text-center text-sm text-gray-500 sm:text-left"><span class="block sm:inline">&copy; 2023 Your Company, Inc.</span> <span class="block sm:inline">All rights reserved.</span></div>
        </div>
      </footer>
    </div>
  </template>
...
export default defineComponent({
  ...
  setup(){
    ...
    const navigation = [
        ...
        { name: 'Link One', href: '#', current: false },
        { name: 'Link Two', href: '#', current: false },
        { name: 'Link Three', href: '#', current: false },
        { name: 'Link Four', href: '#', current: false },
    ]
